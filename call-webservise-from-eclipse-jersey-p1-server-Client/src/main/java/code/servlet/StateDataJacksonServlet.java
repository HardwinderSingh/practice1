...
/**
 * Servlet implementation class StateDataJacksonServlet
 */
@WebServlet("/StateDataJacksonServlet")
public class StateDataJacksonServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			WebResource resource = client.resource("http://localhost:7080/WebService-jersey-P1-ServerSide/container/serverSide/allstateJson");
			...
			for(int i=0;i<=jsonarray.length();i++) {
				 ...
				 statepojo.setState_code(""+jsonObject.getInt("state_code"));
